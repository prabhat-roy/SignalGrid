# TOOLS.md — every OSS tool registered for SignalGrid

This file is the single inventory of every OSS tool wired up for SignalGrid.
...
| domain-oss | [onap](domain-oss/onap/) | `domain-oss/onap/` (deployable) |
| domain-oss | [openran-ric](domain-oss/openran-ric/) | `domain-oss/openran-ric/` (deployable) |
| domain-oss | [streampipes](domain-oss/streampipes/) | `domain-oss/streampipes/` (deployable) |
